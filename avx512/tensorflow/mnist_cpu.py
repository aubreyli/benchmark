...
parser.add_argument('--cpu_number','-c',type=int,default='1',help='cpu_number')
args = parser.parse_args()

cpu_num = args.cpu_number
...
while True:
    ...
    for step in range(steps):
        ...
        if step_count % 100 == 0 and step_count != 0:
            ...
            print("step count:", step_count, "throughput:%.5f(pictures/second)" % (100 * BATCH_SIZE / (end - start)))
            start = time.time()
